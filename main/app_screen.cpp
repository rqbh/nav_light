...
//---------------------
static UINT tjd_s_input( JDEC* jd,    // Decompression object
...
EXT_RAM_ATTR static lv_color_t buf_1[ DISP_BUF_SIZE ];
EXT_RAM_ATTR static lv_color_t buf_2[ DISP_BUF_SIZE ];
