...
{
    if (d->pOrder)     
        d->pOrder=(int*)realloc((void*)(d->pOrder), (d->nChild+d->nText+d->nClear)*sizeof(int));
    if (d->pChild)
        d->pChild = ( XMLNode* )realloc( ( void* )(d->pChild), d->nChild * sizeof( XMLNode ) );
    if (d->pAttribute)
        d->pAttribute = ( XMLAttribute* )realloc( ( void* )(d->pAttribute), d->nAttribute * sizeof( XMLAttribute ) );
    if (d->pText)
        d->pText = ( XMLCSTR* )realloc( ( void* )(d->pText), d->nText * sizeof( XMLSTR ) );
    if (d->pClear)
        d->pClear = ( XMLClear* )realloc( ( void* )(d->pClear), d->nClear * sizeof( XMLClear ) );
}
